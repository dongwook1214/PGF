...
''';
    RSAKeyPairClass keyPair = RSAKeyPairClass.fromPems(pemPublic, pemPrivate);
    print(keyPair.isKeyPairValid());
  });
...
''';
    String encrypted =
        CryptoClass.asymmetricEncryptDataFromPem(pemPublic, "hihi");

    String decrypted =
        CryptoClass.asymmetricDecryptDataFromPem(pemPrivate, encrypted);

    expect(decrypted, "hihi");
  });
